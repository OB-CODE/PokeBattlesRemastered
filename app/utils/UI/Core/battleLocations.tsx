  ...
  const battleLocations: IBattleLocations[] = [
    {
      ...
      repelCost: 2 * ((10 + 10) / 2),
      backgroundPattern: 'radial-gradient(ellipse 80% 50% at 50% 100%, rgba(139, 69, 19, 0.35) 0%, transparent 70%), repeating-linear-gradient(90deg, transparent, transparent 40px, rgba(34, 139, 34, 0.2) 40px, rgba(34, 139, 34, 0.2) 42px)',
    },
    {
      baseMoneyEarnt: 15,
      potentialBonus: 25,
      ...
      repelCost: 2 * ((15 + 25) / 2),
      backgroundPattern: 'radial-gradient(ellipse 120% 40% at 20% 90%, rgba(34, 139, 34, 0.3) 0%, transparent 50%), radial-gradient(ellipse 100% 40% at 80% 95%, rgba(34, 139, 34, 0.25) 0%, transparent 50%), radial-gradient(circle at 10% 80%, rgba(139, 90, 43, 0.2) 0%, transparent 20%)',
    },
    {
      baseMoneyEarnt: 15,
      potentialBonus: 30,
      ...
      repelCost: 2 * ((15 + 30) / 2),
      backgroundPattern: 'radial-gradient(ellipse 60% 80% at 0% 50%, rgba(0, 100, 0, 0.3) 0%, transparent 60%), radial-gradient(ellipse 60% 80% at 100% 50%, rgba(0, 100, 0, 0.3) 0%, transparent 60%), linear-gradient(180deg, rgba(0, 80, 0, 0.15) 0%, transparent 30%)',
    },
    {
      baseMoneyEarnt: 25,
      potentialBonus: 35,
      ...
      repelCost: 2 * ((25 + 35) / 2),
      backgroundPattern: 'radial-gradient(ellipse 100% 50% at 50% 100%, rgba(255, 69, 0, 0.35) 0%, transparent 60%), radial-gradient(circle at 20% 90%, rgba(255, 140, 0, 0.25) 0%, transparent 30%), radial-gradient(circle at 80% 85%, rgba(255, 100, 0, 0.25) 0%, transparent 25%)',
    },
    {
      baseMoneyEarnt: 25,
      potentialBonus: 35,
      ...
      repelCost: 2 * ((25 + 35) / 2),
      backgroundPattern: 'radial-gradient(ellipse 150% 40% at 50% 100%, rgba(0, 100, 180, 0.3) 0%, transparent 70%), repeating-linear-gradient(180deg, transparent, transparent 20px, rgba(100, 180, 255, 0.1) 20px, rgba(100, 180, 255, 0.1) 22px)',
    },
    {
      baseMoneyEarnt: 25,
      potentialBonus: 35,
      ...
      repelCost: 2 * ((25 + 35) / 2),
      backgroundPattern: 'radial-gradient(ellipse 100% 60% at 50% 100%, rgba(34, 139, 34, 0.3) 0%, transparent 60%), repeating-linear-gradient(90deg, transparent, transparent 30px, rgba(0, 128, 0, 0.12) 30px, rgba(0, 128, 0, 0.12) 32px)',
    },
    // {
...

    {
      ...
      backgroundPattern: 'radial-gradient(ellipse 80% 40% at 50% 95%, rgba(80, 80, 80, 0.35) 0%, transparent 60%), repeating-linear-gradient(45deg, transparent, transparent 25px, rgba(60, 60, 60, 0.12) 25px, rgba(60, 60, 60, 0.12) 27px)',
    },
    {
      baseMoneyEarnt: 40,
      potentialBonus: 80,
      ...
      repelCost: 2 * ((40 + 80) / 2),
      backgroundPattern: 'radial-gradient(ellipse 100% 50% at 50% 100%, rgba(75, 0, 130, 0.25) 0%, transparent 60%), radial-gradient(circle at 15% 70%, rgba(50, 50, 50, 0.2) 0%, transparent 25%), radial-gradient(circle at 85% 75%, rgba(50, 50, 50, 0.2) 0%, transparent 25%)',
    },
    {
      baseMoneyEarnt: 50,
      potentialBonus: 150,
      ...
      repelCost: 2 * ((50 + 150) / 2),
      backgroundPattern: 'radial-gradient(ellipse 80% 50% at 50% 50%, rgba(255, 215, 0, 0.2) 0%, transparent 60%), radial-gradient(circle at 30% 30%, rgba(255, 223, 0, 0.15) 0%, transparent 30%), radial-gradient(circle at 70% 70%, rgba(255, 223, 0, 0.15) 0%, transparent 30%)',
    },
  ];
