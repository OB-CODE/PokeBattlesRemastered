              ...
              return (
                ...
                >
                  <div className="w-[85%] max-w-[320px] md:w-[32%]">
                    <div className={`h-100% w-full h-fit p-0.5 rounded-xl shadow-lg bg-gradient-to-br ${typeColor.from} ${typeColor.to}`}>
                      <div className="bg-gradient-to-br from-amber-100 via-yellow-50 to-amber-100 m-1.5 rounded-lg p-1.5">
                        <div
                          className={`w-full rounded-xl shadow-[0_8px_12px_rgba(0,0,0,0.2),0_3px_5px_rgba(0,0,0,0.12)] bg-gradient-to-br from-white via-gray-50 to-gray-100 flex flex-col items-center border ${typeColor.border} overflow-hidden max-h-[60vh] h-[55vh] md:h-[50vh]`}
                        >
                          ...
                          {/* <!-- Middle Div: Image --> */}
                          <div className="h-full flex-grow flex justify-center items-center w-full bg-gradient-to-b from-gray-50 via-white to-gray-100 p-1.5 relative min-h-[110px] md:min-h-[130px]  md:max-h-[150px]">
